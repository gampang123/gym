...
-->
    ...
    <!-- ImgFix -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.imgfix/1.1.0/jquery.imgfix.min.js"></script>

    <!-- MixItUp -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/mixitup/3.3.1/mixitup.min.js"></script>

    <!-- Accordions -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-accordion/1.0.0/jquery.accordion.min.js"></script>
